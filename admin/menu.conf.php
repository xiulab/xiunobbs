...
return array(
	...
	'plugin' => array(
		...
		'tab'=> array (
			...
			'official_free'=>array('url'=>url('plugin-official-0'), 'text'=>lang('admin_plugin_official_free_list')),
			'official_fee'=>array('url'=>url('plugin-official-1'), 'text'=>lang('admin_plugin_official_fee_list')),
		)
	)
);
