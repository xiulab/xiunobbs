...
return array(
	...
	'plugin_dependency_following'=>'( {name} ) dependent on following plugin: {s}, please install them first.',
	'plugin_being_dependent_cant_delete'=>'{s} dependent on: {name}, can not delete ({name})',
