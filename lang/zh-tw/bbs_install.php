...
return array(
	...
	'license_content' => '感謝您選擇 Xiuno BBS 4.0，它是壹款國產、小巧、穩定、支持在大數據量下仍然保持高負載能力的輕型論壇。它只有 20 多個表，源代碼壓縮後 800k 左右，運行速度非常快，處理單次請求在 0.01 秒級別，在有 APC、XCache 的環境下可以跑到 0.00x 秒，對第三方類庫依賴極少，僅僅前端依賴 jquery.js/zepto.js，作者認為它就像壹輛純手工打造的法拉利，動力強勁，沒有壹絲贅肉，方便部署和維護，是壹個非常好的二次開發的基石。
	
Xiuno BBS 4.0 采用 Bootstrap 4.0 + JQuery 1.11 作為前端類庫，全面支持移動端瀏覽器；後端 XiunoPHP 4.0 支持了 NoSQL 的方式操作各種數據庫，這個版本是壹個巨大的飛躍。
