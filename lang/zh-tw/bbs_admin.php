...
return array(
	...
	'forum_cant_delete_system_reserved'=>'請謹慎編輯版塊，壹旦確定後不要輕易變動，否則可能會導致數據關聯錯誤，壹般在正式運營時就不要再變動。',
	...
	'plugin_dependency_following'=>'( {name} ) 依賴以下插件：{s}，請先安裝依賴的插件',
	'plugin_being_dependent_cant_delete'=>'以下插件依賴 ( {name} )：{s}，不能刪除 ( {name} )',
