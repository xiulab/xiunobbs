...
> **[教程请查看 Wiki](https://gitee.com/xiulab/xiunobbs/wikis)**
>
>『本项目并非 XiunoBBS 官方项目，而是第三方派生项目。并且，**此项目已停止维护**』
>
>请各位使用者遵守相关法律法规，严禁使用本程序搭建 **违法、侵权 及 擦边** 的网站，请**自行承担法律风险**。   
>
>众所周知，原作者已关停了官方站点和项目。
>
>（**国内开源环境恶劣：面对抄袭侵权毫无办法不说，还随时面临着被法院传票的风险**）

**【更新说明】**
- 原仓库关闭时，代码最后更新的时间为 `2020年5月8日`，其分支名为 **[master](../../../xiunobbs/tree/master)**。
- 因 `xiuno.com` 站点关闭，插件中心已失效，故最新代码已移除插件中心。
- 已将原代码中的所有插件独立出来成为一个仓库: **[xn_plugins](../../../xn_plugins)**
