...
(function($){
  ...
  function detect(ua){
    ...
    var os = this.os = {},
      ...
      //������19,���firefox��һ�����飺["Firefox/19.0","19.0"];
    ...
    //���chrome��ֵ�Ļ�����browserװ}������firefix��version
    if (chrome) browser.chrome = true, browser.version = chrome[1]

    //���firefox��ֵ�Ļ�����browserװ}������firefix��version
    if (firefox) browser.firefox = true, browser.version = firefox[1]

    //os����һ������tablet4��ʾ�Ƿ���ƽ��
    os.tablet = !!(ipad || playbook || (android && !ua.match(/Mobile/)) || (firefox && ua.match(/Tablet/)))

    //os����һ������phone4��ʾ�Ƿ����ֻ��������⣺�����pc�Ļ��صľ�ȻҲ��true����Ȼ��������ƶ��˵ģ��Ǻǣ����Ժ��ԣ�
  ...
  //��Zepto����һ��keyΪ__detect��Ӧ����detect���function
  $.__detect = detect
