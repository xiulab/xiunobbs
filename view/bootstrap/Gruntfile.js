...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    exec: {
      ...
      xiuno: {
      	command: 'cp -rf dist/css/* ../css/ && php ./xiuno.php'
      }
    },
  ...
  // Publish to GitHub
  grunt.registerTask('publish', ['buildcontrol:pages', "exec:postcss"]);
  grunt.registerTask('xiuno', ['exec:xiuno']);
  
/*  grunt.registerTask('default', 'Log some stuff.', function() {
    grunt.log.write('xxxxxxxxxxxxxxxxxxxxxxxxx').ok();
  });*/
