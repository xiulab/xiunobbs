...
// hook forum_access_func_php_start.php
...
function forum_access_create($arr) {
	// hook forum_access_create_start.php
	$r = forum_access__create($arr);
	// hook forum_access_create_end.php
	return $r;
}

function forum_access_update($fid, $gid, $arr) {
	// hook forum_access_update_start.php
	$r = forum_access__update($fid, $gid, $arr);
	// hook forum_access_update_end.php
	return $r;
}

// 不存在，则创建一条
function forum_access_replace($fid, $gid, $arr) {
	// hook forum_access_replace_start.php
	...
	// hook forum_access_replace_end.php
	return $r;
}

// 根据 gid 补充 forum_access
function forum_access_padding($gid, $fill = FALSE) {
	// hook forum_access_padding_start.php
...
function forum_access_find($cond = array(), $orderby = array(), $page = 1, $pagesize = 20) {
	...
	// hook forum_access_find_end.php
	return $accesslist;
}
...
function forum_access_user($fid, $gid, $access) {
	...
	// hook forum_access_user_end.php
}
...
function forum_access_mod($fid, $gid, $access) {
	// hook forum_access_mod_start.php
...
function forum_access_format(&$access) {
	// hook forum_access_format_start.php
	if(empty($access)) return;
	// hook forum_access_format_end.php
}
...
// hook forum_access_func_php_end.php
